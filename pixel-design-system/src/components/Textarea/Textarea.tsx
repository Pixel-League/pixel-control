...
function getTextareaShadow(theme: Theme, state: FieldState, disabled?: boolean): string {
  if (disabled) {
  ...
  return (
    ...
    >
      <textarea
        ...
        className={cn(
          'w-full font-body text-sm px-4 py-3 placeholder:text-px-label/60 transition-shadow resize-none',
          'focus-visible:outline-none',
          tone.border,
          theme === 'dark' ? 'bg-nm-dark text-px-white' : 'bg-nm-light text-px-offblack',
          getTextareaShadow(theme, state, disabled),
